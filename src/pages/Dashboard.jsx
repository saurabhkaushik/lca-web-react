...
const ReportAnalyser = () => {
  ...
  return (
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
      <Header title="Recruit Assistant - Analyser" /> 
      <p className="text-md font-semibold">Helps you to be greater at recruiter using the power of Gen AI.</p> <br/>
      <form> 
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div >
            ...
            rows="15" 
            cols="100"
            placeholder="Copy the Job Description"
            maxLength="10000"
